	...
	<div id="container">
		<div id="content">
			...
			<div class="section">
				...
				<blockquote class="mainbq"><p>很高兴我们能够在这里相遇 :)</p></blockquote>
				...
				<p>目前还是个学生，同时对互联网颇为感兴趣，所以平时更多地会关注这方面的一些信息。
				对 web 作为客户端有较高的热情，同时也有深入了解后端底层相关知识的渴望。研究课题以食物和历史为主。 </p>
				<p>钦慕日本，源于它的那份认真。日本的工业设计和日本人的一些礼节以及对待文化的态度都是它深深吸引我的地方。13年底终如愿前往，现滞在京都以继续学业。</p>
				<p>喜欢一切美好的事物。美好的概念很宽泛，也许也仅仅是针对我个人而言。比如 New Age 音乐中那一串串天籁般的音符，比如「深夜食堂」中那一幕幕恬美温馨的故事，比如 MUJI 的一些衣物，比如一些优雅干练的汉字字体，再比如新海城动画中，那空灵的苍穹。</p>
				<p>正因为如此，我越发希望自己能够创造能被很多人认为是美好的事物，应用如是。而如果单考虑应用，我希望它不仅仅是 UI 的美好，支撑它的逻辑代码也应该美好 :)</p>
				<br>
				<p>你可以在这里找到我：</p>
				<ul class="me">
